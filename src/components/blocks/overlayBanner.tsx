...
export default function OverlayBanner({content, backgroundImage}: Props) {
  ...
  return ( 
    <>
      <section className="section relative bg-cover bg-center bg-no-repeat w-full flex flex-col items-end justify-end min-h-[668px] after:absolute after:inset-0 after:z-10 after:block after:size-full after:bg-black/40 after:content-[''] md:py-16 xl:px-6 xl:py-28 lg:min-h-[800px]"
        style={{
          backgroundImage:
