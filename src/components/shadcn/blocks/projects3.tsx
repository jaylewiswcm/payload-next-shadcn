...
import { OverlayBanner } from "@/payload-types";
...
interface Projects3Props {
  className?: string;
  content: OverlayBanner['content']
  backgroundImage: OverlayBanner['backgroundImage']
}

const Projects3 = ({ className, content, backgroundImage }: Projects3Props) => {
